<?php
class model_Messages extends abstract_model{
	
	protected $sClassRow='row_Messages';
	
	protected $sTable='Messages';
...
class row_Messages extends abstract_row{
	
	protected $sClassModel='model_Messages';
