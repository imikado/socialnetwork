<?php
class model_Likes extends abstract_model{
	
	protected $sClassRow='row_Likes';
	
	protected $sTable='Likes';
...
class row_Likes extends abstract_row{
	
	protected $sClassModel='model_Likes';
