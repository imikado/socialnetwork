<?php
class model_Albums extends abstract_model{
	
	protected $sClassRow='row_Albums';
	
	protected $sTable='Albums';
...
class row_Albums extends abstract_row{
	
	protected $sClassModel='model_Albums';
